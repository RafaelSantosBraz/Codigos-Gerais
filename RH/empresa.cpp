...
int main(){
    ...
    do {
        ...
        switch (op){
            ...
            case 3: {
                char d;
                cout << "Deseja realmente remover TODOS os setores [s/n]?\n";
                cin >> d;
                if (d == 's'){
                    setores.limpar_tudo();
                }
            ...
            case 4: {
                int p;
                cout << "Posição para remover: ";
                cin >> p;
                char d;
                cout << "Deseja realmente remover este setor [s/n]?\n";
                cin >> d;
                if (d == 's'){
                    if (!setores.remover(p)){
                        cout << "Erro ao remover! Posição inexistente" << endl;
                    }
                }
                break;
            }
...
int menu(){
    ...
    cout << "[3] Limpar Setores" << endl;
    cout << "[4] Remover Setor" << endl;
    cout << "-------------------" << endl;
    cout << "[0] Sair" << endl;
    cout << "Opção: ";
    int op;
